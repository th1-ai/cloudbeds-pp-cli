...
Exit codes & warnings:
  ...
  cloudbeds-pp-cli sync

  # Sync specific resources only
  cloudbeds-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  cloudbeds-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  cloudbeds-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  cloudbeds-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  cloudbeds-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/cloudbeds-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "access_token":
		return db.UpsertAccessToken(data)
	case "create_allotment_block":
		return db.UpsertCreateAllotmentBlock(data)
	case "delete_adjustment":
		return db.UpsertDeleteAdjustment(data)
	case "delete_app_property_settings":
		return db.UpsertDeleteAppPropertySettings(data)
	case "delete_guest_note":
		return db.UpsertDeleteGuestNote(data)
	case "delete_reservation_note":
		return db.UpsertDeleteReservationNote(data)
	case "delete_room_block":
		return db.UpsertDeleteRoomBlock(data)
	case "get_allotment_blocks":
		return db.UpsertGetAllotmentBlocks(data)
	case "get_currency_settings":
		return db.UpsertGetCurrencySettings(data)
	case "get_custom_fields":
		return db.UpsertGetCustomFields(data)
	case "get_dashboard":
		return db.UpsertGetDashboard(data)
	case "get_email_schedule":
		return db.UpsertGetEmailSchedule(data)
	case "get_email_templates":
		return db.UpsertGetEmailTemplates(data)
	case "get_files":
		return db.UpsertGetFiles(data)
	case "get_groups":
		return db.UpsertGetGroups(data)
	case "get_guest_list":
		return db.UpsertGetGuestList(data)
	case "get_guest_notes":
		return db.UpsertGetGuestNotes(data)
	case "get_guests_by_filter":
		return db.UpsertGetGuestsByFilter(data)
	case "get_guests_by_status":
		return db.UpsertGetGuestsByStatus(data)
	case "get_guests_modified":
		return db.UpsertGetGuestsModified(data)
	case "get_hotels":
		return db.UpsertGetHotels(data)
	case "get_house_account_list":
		return db.UpsertGetHouseAccountList(data)
	case "get_housekeepers":
		return db.UpsertGetHousekeepers(data)
	case "get_housekeeping_status":
		return db.UpsertGetHousekeepingStatus(data)
	case "get_item":
		return db.UpsertGetItem(data)
	case "get_items":
		return db.UpsertGetItems(data)
	case "get_package_names":
		return db.UpsertGetPackageNames(data)
	case "get_packages":
		return db.UpsertGetPackages(data)
	case "get_payments_capabilities":
		return db.UpsertGetPaymentsCapabilities(data)
	case "get_rate_jobs":
		return db.UpsertGetRateJobs(data)
	case "get_rate_plans":
		return db.UpsertGetRatePlans(data)
	case "get_reservation":
		return db.UpsertGetReservation(data)
	case "get_reservation_notes":
		return db.UpsertGetReservationNotes(data)
	case "get_reservation_room_details":
		return db.UpsertGetReservationRoomDetails(data)
	case "get_reservations":
		return db.UpsertGetReservations(data)
	case "get_reservations_with_rate_details":
		return db.UpsertGetReservationsWithRateDetails(data)
	case "get_room_blocks":
		return db.UpsertGetRoomBlocks(data)
	case "get_room_types":
		return db.UpsertGetRoomTypes(data)
	case "get_rooms_fees_and_taxes":
		return db.UpsertGetRoomsFeesAndTaxes(data)
	case "get_sources":
		return db.UpsertGetSources(data)
	case "get_taxes_and_fees":
		return db.UpsertGetTaxesAndFees(data)
	case "get_webhooks":
		return db.UpsertGetWebhooks(data)
	case "list_allotment_block_notes":
		return db.UpsertListAllotmentBlockNotes(data)
	case "oauth":
		return db.UpsertOauth(data)
	case "patch_group":
		return db.UpsertPatchGroup(data)
	case "patch_rate":
		return db.UpsertPatchRate(data)
	case "post_adjustment":
		return db.UpsertPostAdjustment(data)
	case "post_custom_field":
		return db.UpsertPostCustomField(data)
	case "post_custom_payment_method":
		return db.UpsertPostCustomPaymentMethod(data)
	case "post_email_schedule":
		return db.UpsertPostEmailSchedule(data)
	case "post_email_template":
		return db.UpsertPostEmailTemplate(data)
	case "post_file":
		return db.UpsertPostFile(data)
	case "post_government_receipt":
		return db.UpsertPostGovernmentReceipt(data)
	case "post_group_note":
		return db.UpsertPostGroupNote(data)
	case "post_guest":
		return db.UpsertPostGuest(data)
	case "post_guest_document":
		return db.UpsertPostGuestDocument(data)
	case "post_guest_note":
		return db.UpsertPostGuestNote(data)
	case "post_guest_photo":
		return db.UpsertPostGuestPhoto(data)
	case "post_guests_to_room":
		return db.UpsertPostGuestsToRoom(data)
	case "post_housekeeper":
		return db.UpsertPostHousekeeper(data)
	case "post_housekeeping_assignment":
		return db.UpsertPostHousekeepingAssignment(data)
	case "post_housekeeping_status":
		return db.UpsertPostHousekeepingStatus(data)
	case "post_item":
		return db.UpsertPostItem(data)
	case "post_item_category":
		return db.UpsertPostItemCategory(data)
	case "post_new_house_account":
		return db.UpsertPostNewHouseAccount(data)
	case "post_payment":
		return db.UpsertPostPayment(data)
	case "post_reservation":
		return db.UpsertPostReservation(data)
	case "post_reservation_document":
		return db.UpsertPostReservationDocument(data)
	case "post_reservation_note":
		return db.UpsertPostReservationNote(data)
	case "post_room_assign":
		return db.UpsertPostRoomAssign(data)
	case "post_room_block":
		return db.UpsertPostRoomBlock(data)
	case "post_room_check_in":
		return db.UpsertPostRoomCheckIn(data)
	case "post_room_check_out":
		return db.UpsertPostRoomCheckOut(data)
	case "post_void_item":
		return db.UpsertPostVoidItem(data)
	case "post_void_payment":
		return db.UpsertPostVoidPayment(data)
	case "put_group":
		return db.UpsertPutGroup(data)
	case "put_guest":
		return db.UpsertPutGuest(data)
	case "put_guest_note":
		return db.UpsertPutGuestNote(data)
	case "put_house_account_status":
		return db.UpsertPutHouseAccountStatus(data)
	case "put_housekeeper":
		return db.UpsertPutHousekeeper(data)
	case "put_item_to_inventory":
		return db.UpsertPutItemToInventory(data)
	case "put_rate":
		return db.UpsertPutRate(data)
	case "put_reservation":
		return db.UpsertPutReservation(data)
	case "put_reservation_note":
		return db.UpsertPutReservationNote(data)
	case "put_room_block":
		return db.UpsertPutRoomBlock(data)
	case "update_allotment_block":
		return db.UpsertUpdateAllotmentBlock(data)
	case "userinfo":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"get-app-settings":                   "/getAppSettings",
		"get-app-state":                      "/getAppState",
		"get-currency-settings":              "/getCurrencySettings",
		"get-custom-fields":                  "/getCustomFields",
		"get-dashboard":                      "/getDashboard",
		"get-email-schedule":                 "/getEmailSchedule",
		"get-email-templates":                "/getEmailTemplates",
		"get-files":                          "/getFiles",
		"get-guest":                          "/getGuest",
		"get-guest-list":                     "/getGuestList",
		"get-guests-by-filter":               "/getGuestsByFilter",
		"get-guests-by-status":               "/getGuestsByStatus",
		"get-guests-modified":                "/getGuestsModified",
		"get-hotel-details":                  "/getHotelDetails",
		"get-hotels":                         "/getHotels",
		"get-house-account-list":             "/getHouseAccountList",
		"get-housekeepers":                   "/getHousekeepers",
		"get-housekeeping-status":            "/getHousekeepingStatus",
		"get-item-categories":                "/getItemCategories",
		"get-items":                          "/getItems",
		"get-package-names":                  "/getPackageNames",
		"get-packages":                       "/getPackages",
		"get-payment-methods":                "/getPaymentMethods",
		"get-payments-capabilities":          "/getPaymentsCapabilities",
		"get-rate-jobs":                      "/getRateJobs",
		"get-reservation-assignments":        "/getReservationAssignments",
		"get-reservations":                   "/getReservations",
		"get-reservations-with-rate-details": "/getReservationsWithRateDetails",
		"get-room-blocks":                    "/getRoomBlocks",
		"get-room-types":                     "/getRoomTypes",
		"get-rooms":                          "/getRooms",
		"get-rooms-unassigned":               "/getRoomsUnassigned",
		"get-sources":                        "/getSources",
		"get-taxes-and-fees":                 "/getTaxesAndFees",
		"get-users":                          "/getUsers",
