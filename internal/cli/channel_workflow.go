...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  cloudbeds-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  cloudbeds-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"get-app-settings", "get-app-state", "get-currency-settings", "get-custom-fields", "get-dashboard", "get-email-schedule", "get-email-templates", "get-files", "get-guest", "get-guest-list", "get-guests-by-filter", "get-guests-by-status", "get-guests-modified", "get-hotel-details", "get-hotels", "get-house-account-list", "get-housekeepers", "get-housekeeping-status", "get-item-categories", "get-items", "get-package-names", "get-packages", "get-payment-methods", "get-payments-capabilities", "get-rate-jobs", "get-reservation-assignments", "get-reservations", "get-reservations-with-rate-details", "get-room-blocks", "get-room-types", "get-rooms", "get-rooms-unassigned", "get-sources", "get-taxes-and-fees", "get-users", "get-webhooks", "oauth", "userinfo"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  cloudbeds-pp-cli workflow status

  # Show status as JSON
  cloudbeds-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("cloudbeds-pp-cli")
			}
