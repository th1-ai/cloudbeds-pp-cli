...
large datasets as it has no memory pressure.`,
  ...
  cloudbeds-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  cloudbeds-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  cloudbeds-pp-cli export <resource> --format jsonl | jq '.id'`,
