...
but do not stop the import.`,
  ...
  cloudbeds-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  cloudbeds-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | cloudbeds-pp-cli import <resource> --input -`,
